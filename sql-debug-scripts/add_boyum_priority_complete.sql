-- =====================================================
-- Add Complete Company Priority with Milestones for Boyum (Q3 2025)
-- =====================================================
...
BEGIN
    ...
    IF priority_id IS NOT NULL THEN
        RAISE NOTICE 'Priority already exists with ID: %', priority_id;
    ...
    ELSE
        ...
        INSERT INTO quarterly_priorities (
            ...
            org_id,
            '00000000-0000-0000-0000-000000000000'::uuid,  -- Boyum owns this special UUID
...
GROUP BY p.id, p.title, p.quarter, p.year;
