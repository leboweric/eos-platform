    ...
    try {
      const result = await client.query(`
        SELECT 
          ...
          mas.meeting_focus_score,
          mas.segue_duration_minutes,
          mas.scorecard_duration_minutes,
          mas.rock_review_duration_minutes,
          mas.headline_duration_minutes,
          mas.ids_duration_minutes,
