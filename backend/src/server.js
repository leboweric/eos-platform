...
app.use('/api/v1/organizations/:orgId/teams/:teamId/vto', businessBlueprintRoutes);
app.use('/api/v1/organizations/:orgId/teams/:teamId/rocks', quarterlyPrioritiesRoutes);
